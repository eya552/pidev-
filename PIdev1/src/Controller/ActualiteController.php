...
class ActualiteController extends AbstractController
{
    ...
    public function new(Request $request,  ActualiteRepository $actualiteRepository, EntityManagerInterface $entityManager, FlashyNotifier $flashy): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try{
             ...
             $entityManager->flush();
             $flashy->success('Actualité ajoutée avec succes!', 'http://your-awesome-link.com');
    ...
    #[Route('/{id}/show', name: 'app_actualite_show', methods: ['GET'])]
    ...
    public function edit(Request $request, Actualite $actualite, ActualiteRepository $actualiteRepository,FlashyNotifier $flashy): Response
    {
        $form = $this->createForm(ActualiteType::class, $actualite);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $actualiteRepository->save($actualite, true);
            $flashy->warning('Actualité modifiée !', 'http://your-awesome-link.com');
    ...
    public function delete(Request $request, Actualite $actualite, ActualiteRepository $actualiteRepository, FlashyNotifier $flashy): Response
    {
        if ($this->isCsrfTokenValid('delete'.$actualite->getId(), $request->request->get('_token'))) {
            $actualiteRepository->remove($actualite, true);
            $flashy->error('Actualité supprimée !', 'http://your-awesome-link.com');
